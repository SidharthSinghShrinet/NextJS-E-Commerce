...
function Footer2() {
  return (
    <div className="bg-neutral-secondary w-full border-t-[1px] border-gray-300">
      <div className="bg-neutral-secondary-soft px-4 py-6 md:flex md:items-center md:justify-between">
        <span className="text-body text-sm sm:text-center">
          © 2025 <a href="https://flowbite.com/">DesireMart™</a>. All Rights
          Reserved.
        </span>
        <div className="mt-4 flex space-x-2 sm:justify-center md:mt-0 rtl:space-x-reverse">
